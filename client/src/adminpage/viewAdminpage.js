          ...
          <div className=" image d-flex flex-column justify-content-center align-items-center">
            ...
            <button className="btn btn-secondary">
              ...
              {product.img ?<img
                ...
                width="100"
                alt="sdf"
              /> : <img src="" alt="https://www.w3schools.com/w3images/avatar2.png"/>}
            </button>{" "}
            ...
            <div className=" d-flex mt-2">
              {" "}
             <Link to={`/adminproductupdate/${product._id}`}> <button className="btn1 btn-dark" >update product</button></Link>
            </div>
